...
const KidsProductInputPage = () => {
  ...
  const handleChange = (e) => {
    ...
    // Prevent negative values for price, discount, and rating
    if (
      (name === "price" || name === "discount" || name === "rating") &&
      value < 0
    ) {
      return; // Don't update if the value is negative
    }
  ...
  const handleImageUpload = (e) => {
    ...
    files.forEach((file) => {
      ...
      // Create a new Image object to check the aspect ratio
      const img = new Image();
      ...
      img.onload = () => {
        ...
        // If both checks pass, proceed with updating state
        const urls = [objectURL];
        setColorImages((prev) => ({ ...prev, [newColor]: files }));
        setPreviews((prev) => ({ ...prev, [newColor]: urls }));
      };
  ...
  return (
    <div className={styles.page}>
      <div className={styles.container}>
        // In your ProductInputPage component, replace the Modal usage with:
        {errorMessage && (
          <Modal
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.overviewSection}>
                ...
                <div className={styles.overviewRow}>
                  ...
                  {formData.customFields.gender || formData.gender}
                </div>
                <div className={styles.overviewRow}>
...
export default KidsProductInputPage;
