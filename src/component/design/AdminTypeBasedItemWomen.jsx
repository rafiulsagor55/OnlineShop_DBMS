...
const AdminTypeBasedItemWomen = () => {
  ...
  const isAdminWomensWearPage = location.pathname === "/admin/womens-wear";

  return (
    <div>
      <Outlet />
      {isAdminWomensWearPage && (
        <div>
          <h2 className={styles.titleMain}>Admin Women's Wear</h2>
...
export default AdminTypeBasedItemWomen;